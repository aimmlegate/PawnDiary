...
| `PawnDiaryCreepJoinerFlowTests` | A2.0 | Exact optional hook registration, canonical/repeated arrival continuity, real rejection/aggression/departure calls, nested ownership, writer roles, repeat/no-op silence, and lifecycle reset. |
