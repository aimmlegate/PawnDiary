...
| `PawnDiaryPawnProgressionFlowTests` | 15 | Skill/trait milestone baseline + upward-only + arc request; installed-Royalty psylink and title scanners with repeat suppression. |
...
| `PawnDiaryOdysseyJourneyFlowTests` | O1.2 | Loaded Odyssey XML policy, guarded location/mobile-home projection, exact onboard scoping, additive journey/history Scribe keys, silent old-save baseline, and corrupt/oversized-state repair; no journey hooks or pages yet. |
