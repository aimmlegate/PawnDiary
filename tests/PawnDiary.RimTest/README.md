...
| `PawnDiaryRitualFlowTests` | 17 / Ideology P2 ritual | Ideology/Anomaly four-perspective production fan-out through internal fact fixtures, pawn-ID uniqueness, colony dedup, context/localization, and DLC-safe fields; exact completed-conversion classification/settings, real patched target mutation, POV isolation, event-time/Scribe retention, quality non-proof, and fail-open behavior. |
