...
| `PawnDiaryRimTalkBridgeRuntimeTests` | B1 adapter | Reflection-only smoke against the actually loaded RimTalk + bridge assemblies: growth/birth shared-memory injection without duplicate or recursive Pawn Diary submission. |
