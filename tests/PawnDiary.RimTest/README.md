...
| `PawnDiaryAnomalyStateFixtureTests` | A1.1 save | Actual six-key component Scribe round-trip, missing-key legacy defaults, deep monolith snapshot, guarded active-DLC baseline, DLC-off deferral, and transient load reset. |
