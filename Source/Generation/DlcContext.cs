...
namespace PawnDiary
{
    public static class DlcContext
    {
        ...
        // Biotech, and empty for a plain Baseliner human — that's the vanilla default and carries
        // no signal worth spending prompt tokens on. A custom-named xenotype (UniqueXenotype) is
        // always shown.
