// Public read-only DTO for fetching one diary entry by handle/id.
// It exposes player-visible completed prose plus compact lifecycle/display metadata: no prompts,
// raw provider responses, errors, or live RimWorld objects.
//
// New to C#/RimWorld? See AGENTS.md.
namespace PawnDiary.Integration
{
    /// <summary>
    /// One diary entry POV exposed through the public integration API.
    /// </summary>
    public sealed class DiaryEntrySnapshot
    {
        ...
        /// <summary>True when this entry is outside the active generation scan window or from compact archive.</summary>
        ...
        /// <summary>Completed player-visible diary prose. Empty until prose exists.</summary>
