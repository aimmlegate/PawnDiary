...
namespace PawnDiary
{
    ...
    public partial class SavedImportedSummaryContributionEvidenceV1 : IExposable, IMemoryLogicalSizeSource
    {
    ...
    public partial class SavedImportedMemoryRow : IExposable, IMemoryLogicalSizeSource
    {
        public int schemaVersion = 1;
    ...
    /// </summary>
    public partial class SavedLegacyUnresolvedOwnerArchiveInputV1 : IExposable, IMemoryLogicalSizeSource
    {
        public int schemaVersion = 1;
        /// <summary>Exactly exact_id | blank | conflicting.</summary>
        public string savedOwnerIdentityKindToken = string.Empty;
