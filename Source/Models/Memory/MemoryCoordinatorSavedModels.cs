...
namespace PawnDiary
{
    ...
    public partial class SavedMemoryAppliedPolicyStateV1 : IExposable, IMemoryLogicalSizeSource
    {
    ...
    public partial class SavedSummaryWordingOpportunityV1 : IExposable, IMemoryLogicalSizeSource
    {
        public int schemaVersion = 1;
    ...
    public partial class SavedMemoryDiagnosticCounter : IExposable, IMemoryLogicalSizeSource
    {
        public int schemaVersion = 1;
    ...
    public partial class SavedMemoryAttemptAuditRow : IExposable, IMemoryLogicalSizeSource
    {
        public int schemaVersion = 1;
    ...
    public partial class SavedLegacyOwnerEpochReservation : IExposable, IMemoryLogicalSizeSource
    {
        public int schemaVersion = 1;
        public string ownerPawnId = string.Empty;
    ...
    public partial class SavedMemoryRepetitionGuardRow : IExposable, IMemoryLogicalSizeSource
    {
        public int schemaVersion = 1;
        public string ownerEpochToken = string.Empty;
