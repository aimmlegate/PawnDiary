...
namespace PawnDiary
{
    ...
    /// </summary>
    public class SavedMemoryAwarenessSnapshot : IExposable
    {
    ...
    public class SavedMemoryCaptureEpisode : IExposable
    {
        public int schemaVersion = 1;
    ...
    /// </summary>
    public class SavedGlobalFactionSnapshot : IExposable
    {
        public int schemaVersion = 1;
