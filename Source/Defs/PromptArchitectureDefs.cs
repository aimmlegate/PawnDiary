    ...
    public static class DiaryPromptTemplates
    {
        ...
        private static List<DiaryPromptFieldDef> FallbackFieldsFor(string templateKey)
        {
            ...
            return Fields(
                ...
                ContextField("ability", "ability_label"),
                ContextField("ability category", "ability_category"),
                ContextField("ability target", "ability_target"),
                ContextField("ability cooldown ticks", "ability_cooldown_ticks"),
