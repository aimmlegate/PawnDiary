...
namespace PawnDiary
{
    public partial class DiaryGameComponent
    {
        ...
        private static readonly DevPromptSuiteEntry[] SuiteEntries =
        {
            ...
            SoloWithLocalizedMarkers(
                "RoyalBestowing",
                "PawnDiary.Dev.PromptSuite.RoyalBestowing.Label",
                "BestowingCeremony",
                "PawnDiary.Dev.PromptSuite.RoyalBestowing.Markers",
                "PawnDiary.Dev.PromptSuite.RoyalBestowing.Text"),
            SoloWithLocalizedMarkers(
                "RoyalAnimaLinking",
                "PawnDiary.Dev.PromptSuite.RoyalAnimaLinking.Label",
                "AnimaTreeLinking",
                "PawnDiary.Dev.PromptSuite.RoyalAnimaLinking.Markers",
                "PawnDiary.Dev.PromptSuite.RoyalAnimaLinking.Text"),
            ...
            SoloWithLocalizedMarkers(
                "ProgressionPsylinkNeuroformer",
                "PawnDiary.Dev.PromptSuite.ProgressionPsylinkNeuroformer.Label",
                ProgressionEventData.PsylinkLevelDefName,
                "PawnDiary.Dev.PromptSuite.ProgressionPsylinkNeuroformer.Markers",
                "PawnDiary.Dev.PromptSuite.ProgressionPsylinkNeuroformer.Text"),
            ...
            Solo("BiotechGeneIdentityReimplant", "PawnDiary.Event.Biotech.GeneIdentity.Label", ProgressionEventData.GeneIdentityChangedDefName,
                "progression=GeneIdentityChanged; progression_kind=gene_identity; previous_value=Baseliner; new_value=Sanguophage; gene_identity_transition=true; previous_xenotype=Baseliner; previous_xenotype_def=Baseliner; xenotype=Sanguophage; xenotype_def=Sanguophage; gene_change_cause=xenogerm_reimplant; other_pawn=Morgan; other_pawn_id=Pawn_2; gene_theme_1=Hemogen dependency; gene_theme_description_1=Needs hemogen regularly to survive.; gene_theme_change_1=added; gene_theme_category_1=need; narrative_facets=identity_transition; major_xenotype=true",
                null, "PawnDiary.Event.Biotech.GeneIdentity.Text"),
            SoloWithLocalizedMarkers(
                "RoyalTitleGained",
                "PawnDiary.Dev.PromptSuite.RoyalTitleGained.Label",
                ProgressionEventData.RoyalTitleGainedDefName,
                "PawnDiary.Dev.PromptSuite.RoyalTitleGained.Markers",
                "PawnDiary.Dev.PromptSuite.RoyalTitleGained.Text"),
            SoloWithLocalizedMarkers(
                "RoyalTitlePromoted",
                "PawnDiary.Dev.PromptSuite.RoyalTitlePromoted.Label",
                ProgressionEventData.RoyalTitlePromotedDefName,
                "PawnDiary.Dev.PromptSuite.RoyalTitlePromoted.Markers",
                "PawnDiary.Dev.PromptSuite.RoyalTitlePromoted.Text"),
            SoloWithLocalizedMarkers(
                "RoyalTitleDemoted",
                "PawnDiary.Dev.PromptSuite.RoyalTitleDemoted.Label",
                ProgressionEventData.RoyalTitleDemotedDefName,
                "PawnDiary.Dev.PromptSuite.RoyalTitleDemoted.Markers",
                "PawnDiary.Dev.PromptSuite.RoyalTitleDemoted.Text"),
            SoloWithLocalizedMarkers(
                "RoyalTitleLost",
                "PawnDiary.Dev.PromptSuite.RoyalTitleLost.Label",
            ...
            SoloWithLocalizedMarkers(
                "RoyalPermitMilitaryAid",
                "PawnDiary.Dev.PromptSuite.RoyalPermitMilitaryAid.Label",
                RoyalPermitPolicy.MilitaryAidEventDefName,
                "PawnDiary.Dev.PromptSuite.RoyalPermitMilitaryAid.Markers",
                "PawnDiary.Dev.PromptSuite.RoyalPermitMilitaryAid.Text"),
            SoloWithLocalizedMarkers(
                "RoyalPermitTransportShuttle",
                "PawnDiary.Dev.PromptSuite.RoyalPermitTransportShuttle.Label",
                RoyalPermitPolicy.TransportShuttleEventDefName,
                "PawnDiary.Dev.PromptSuite.RoyalPermitTransportShuttle.Markers",
                "PawnDiary.Dev.PromptSuite.RoyalPermitTransportShuttle.Text"),
            SoloWithLocalizedMarkers(
                "RoyalPermitOrbitalStrike",
                "PawnDiary.Dev.PromptSuite.RoyalPermitOrbitalStrike.Label",
                RoyalPermitPolicy.OrbitalStrikeEventDefName,
                "PawnDiary.Dev.PromptSuite.RoyalPermitOrbitalStrike.Markers",
                "PawnDiary.Dev.PromptSuite.RoyalPermitOrbitalStrike.Text"),
            SoloWithLocalizedMarkers(
                "RoyalPermitOrbitalSalvo",
                "PawnDiary.Dev.PromptSuite.RoyalPermitOrbitalSalvo.Label",
                RoyalPermitPolicy.OrbitalSalvoEventDefName,
                "PawnDiary.Dev.PromptSuite.RoyalPermitOrbitalSalvo.Markers",
                "PawnDiary.Dev.PromptSuite.RoyalPermitOrbitalSalvo.Text"),
