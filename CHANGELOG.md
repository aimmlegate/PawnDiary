...
- **Repository wiki actualization.** Rebuilt the XML Definition System landing page from the live catalog and added a deterministic generator/checker that publishes one source-linked reference page for every shipped Def type.
