...
- **General runtime review hardening.** Isolated fragile hook registration, restored chronological historical-event scans, verified romance transitions, flattened ritual context fields, refreshed live matcher/weather caches, aligned external solo dedup, and rebuilt quadrum guards from archived pages; added focused regressions.
