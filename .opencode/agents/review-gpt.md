---
description: Adversarial reviewer on GPT-5.5 (xhigh reasoning). Two modes: defect review (bugs, security, DLC-safety, design flaws) and architecture review (structural improvements with pros/cons). Read-only.
mode: subagent
