...
picker, pending/raw/failure rows, prompt/status diagnostics, in-progress indicators, and mock-page
fill. Long histories page by in-game year. Cards show date/title, accent, group chip, model id,
linked POV previews, and title-pending animation.
