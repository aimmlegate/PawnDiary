...
| `API_V4_PAWN_CONTEXT_PROVIDERS.md` | Implemented design record for capability C-CTX-1 (API v4 `RegisterPawnContextProvider`): surface, sanitation/failure-isolation, purity boundary, player-toggle decision, and the RimPsyche consumer snippet. | implemented 2026-07-04 |
